...
export const AI_NAME = "Markus, your AI assistant";
export const OWNER_NAME = "Neeraj Balani";

export const WELCOME_MESSAGE = `Hello! I'm ${AI_NAME}, an AI assistant that will help you find suitable AI tool created by ${OWNER_NAME}.`
